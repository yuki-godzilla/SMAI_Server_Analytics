...
$action = New-ScheduledTaskAction -Execute $powershell -Argument ('-NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "{0}" -Mode autofix-worker -PythonPath "{1}"' -f $runner, $python) -WorkingDirectory $projectRoot
